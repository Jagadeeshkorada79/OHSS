...
<body>
  <form action="forgotcf.php" method="POST">
    <div class="login-box">
...
if (isset($_POST['update'])) {
  ...
  $cpass=($_POST['cpassword']);
    ...
    $sqlc="SELECT * FROM logcf WHERE username='$uname'";
    ...
    if (mysqli_num_rows($resultcf) === 1 ) {
      ...
      if ($rowc['username'] === $uname ) {
          if ($pass===$cpass) {
     $sqlc="UPDATE logcf SET password='$pass' WHERE username='$uname' ";
