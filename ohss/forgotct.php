...
<body>
  <form action="forgotct.php" method="POST">
    <div class="login-box">
...
if (isset($_POST['update'])) {
  ...
  elseif (empty($cpass)) {
    ...
    $sqlct="SELECT * FROM logct WHERE username='$uname'";
    ...
    if ( mysqli_num_rows($resultct) === 1) {
      ...
      if ( $rowct['username'] === $uname) {
          if ($pass===$cpass) {
         $sqlct="UPDATE logct SET password='$pass' WHERE username='$uname' ";
