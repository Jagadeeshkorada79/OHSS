...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
  ...
  include 'db_con.php';
  $sqlc="SELECT * FROM cfdata WHERE uemail='$usermail'";
...
<body>
<center class="title">CHIEF WARDEN</center>
<div class="container ct">
<div class="navbar">
  <a class="active" href="chiefwarden.php"><i class="fa fa-fw fa-home"></i> Home</a> 
  <a href="about.php"><i class="fa fa-fw fa-question"></i>About</a>
  <a href="contact.php"><i class ="fa fa-fw fa-envelope"></i>Contact</a>
  <a class="link dim dark-gray f3 dib mr3 mr4-l" href="chief.php" style="margin-left: 700px">WELCOME <?php echo $rowc['uname']; ?> </a>
  <input type="search" placeholder="search...." style="margin-left: 40px"><a><i class="fa fa-fw fa-search"></i></a>
  <div class="dropdowna">
                    <!-- three dots -->
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'wd')">Warden</button>
...
<div id="lo" class="tabcontent" style="overflow-y: scroll;">
  <table class="tb1">
    ...
    <tr class="tr1" style="text-align: center;">
     ...
     <td class="td1"><a href="outleav.php?id=<?php echo $rowt['id'] ?>"><button type="submit" name="Approved" class="btn btn-danger">Status</button></a>
              </td>
    </tr>
    <?php
                     }
...
<?php
               ...
               $count_run=mysqli_query($conn,$count);
                ?>
  <div style="width: 50%; float: left;"><p>Today no of leaves:<input type="text" name="le" value="<?php echo (mysqli_num_rows($count_run))?>" readonly></p></div>
  <?php 
$countout = "SELECT * from `outleave` where  type='outing' && status='Approved'";
               $countout_run=mysqli_query($conn,$countout);
  ?>
  <div style="width: 50%; float: left;"><p>Today no of outings:<input type="text" name="out" value="<?php echo (mysqli_num_rows($countout_run))?>" readonly></p></div>
</div>
...
<div class="tc" id='week'>
 ...
 <div style="width: 100%; height: 30px;">
  <?php
               ...
               $count_run=mysqli_query($conn,$count);
                ?>
  <div style="width: 50%; float: left;"><p>This Week no of leaves:<input type="text" name="le" value="<?php echo (mysqli_num_rows($count_run))?>" readonly></p></div>
   <?php 
$countout = "SELECT * from `outleave` where  type='outing' && status='Approved'";
               $countout_run=mysqli_query($conn,$countout);
  ?>
  <div style="width: 50%; float: left;"><p>This Week no of outings:<input type="text" name="out" value="<?php echo (mysqli_num_rows($countout_run))?>" readonly>></p></div>
</div>
<div style="margin-top: 60px;">
  <table class="tb1">
    <tr class="tr1">
...
<div class="tc" id='month'>
 <div style="width: 100%; height: 30px;">
   <?php
               ...
               $count_run=mysqli_query($conn,$count);
                ?>
  <div style="width: 50%; float: left;"><p>This Month no of leaves:<input type="text" name="le" value="<?php echo (mysqli_num_rows($count_run))?>" readonly></p></div>
   <?php 
$countout = "SELECT * from `outleave` where  type='outing' && status='Approved'";
               $countout_run=mysqli_query($conn,$countout);
  ?>
  <div style="width: 50%; float: left;"><p>This Month no of outings:<input type="text" name="out" value="<?php echo (mysqli_num_rows($countout_run))?>" readonly></p></div>
</div>
<div style="margin-top: 60px;">
  <table class="tb1">
    <tr class="tr1">
...
<div class="tc" id='all'>
 <div style="width: 100%; height: 30px;">
   <?php
               ...
               $count_run=mysqli_query($conn,$count);
                ?>
  <div style="width: 50%; float: left;"><p>Total no of leaves:<input type="text" name="le" value="<?php echo (mysqli_num_rows($count_run))?>" readonly></p></div>
   <?php 
$countout = "SELECT * from `outleave` where  type='outing' && status='Approved'";
               $countout_run=mysqli_query($conn,$countout);
  ?>
  <div style="width: 50%; float: left;"><p>Total no of outings:<input type="text" name="out" value="<?php echo (mysqli_num_rows($countout_run))?>" readonly></p></div>
</div>
<div style="margin-top: 60px;">
  <table class="tb1">
    <tr class="tr1">
...
<div id="id1" class="modal">
   <div class="modal-content animate" style="border: 5px solid green;">
    ...
    if(isset($_POST['notify'])){
      ...
      $note="INSERT INTO `notification`(`id`, `notification`, `udate`, `uby`) VALUES (NULL,'$notifi',CURRENT_TIMESTAMP,'chiefwarden')";
...
if (isset($_POST['search'])) {
  ...
  $sql="SELECT * FROM sdata WHERE uid='$id'";
    ...
    <tr class="tr2"><td><td style="margin-left: 10px;">NAME :</td><td><input type="text" name="uname" style="padding-right: 60px; margin-left: 3px;" value="<?php echo $row['uname'] ?>" readonly></td></tr>
      ...
      <tr class="tr2"><td></td><td>GENDER :</td><td><input type="text" name="uid" style="padding-right: 60px; margin-left: 3px;" value="<?php echo $row['ugender'] ?>" readonly></td></tr>
      <tr class="tr2"><td></td><td>CASTE:</td><td><input type="text" name="uid" style="padding-right: 60px; margin-left: 3px;" value="<?php echo $row['ucaste'] ?>" readonly></td></tr>
...
<div id="rd" class="tabcontent">
  ...
  <div class="h">
    <button class="hl" onclick="opena(event,'i2')" id="r">I2</button>
    <button class="hl" onclick="opena(event,'i1')">I3</button>
    <button class="hl" onclick="opena(event,'k4')">K4</button>
  </div>
  <div class="hcontent" id="i2">
  ...
  <div class="roomcontent" id="ff">
    ...
    <?php
                $fill = "SELECT * from `roomdata` where hostel='i2' && floor='1' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='i2' && floor='1' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='i2' && floor='1' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
        <td>Fully allocated rooms:</td>
        <td><input type="text" name="allocated" style="padding-right: 60px; margin-left: 3px;" value="<?php echo (mysqli_num_rows($fill_run))?>" readonly></td>
      </tr>
      <tr>
        <td>Partially allocated rooms:</td>
        <td><input type="text" name="allocated" style="padding-right: 60px; margin-left: 3px;" value="<?php echo (mysqli_num_rows($offill_run))?>" readonly></td>
      </tr>
      <tr>
        <td>Unpartially allocated rooms:</td>
        <td><input type="text" name="allocated" style="padding-right: 60px; margin-left: 3px;" value="<?php echo (mysqli_num_rows($unfill_run))?>" readonly></td>
      </tr>
    </table>
  </div>
  <div class="roomcontent" id="sf">
    <h1>I2 SecondFloor Room Details</h1>
     <?php
                $fill = "SELECT * from `roomdata` where hostel='i2' && floor='2' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='i2' && floor='2' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='i2' && floor='2' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
  ...
  <div class="roomcontent" id="tf">
    <h1>I2 ThirdFloor Room Details</h1>
     <?php
                $fill = "SELECT * from `roomdata` where hostel='i2' && floor='3' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='i2' && floor='3' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='i2' && floor='3' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
...
if (isset($_POST['sea'])) {
  ...
  $sql="SELECT * FROM sdata WHERE uid='$uid'";
    ...
    <table style="margin-top: 5px; margin-left: 40px; height: 400px;">
      ...
      <tr>
        <td>ALLOCATE ROOM:</td>
        <td><input type="text" name="uroom" style=" margin-left: 3px;" value="<?php echo $row['uroom'] ?>"></td>
      </tr>
    </table>
    <center><input type="submit" name="upromi2" value="UPDATE"></center>
    <?php
include 'db_con.php';
 if (isset($_POST['upromi2'])) {
  $id=$_POST['uid']; 
  $uroom=$_POST['uroom'];
  $sql="UPDATE sdata SET `uroom`='$uroom' WHERE uid='$id' ";
  $sqll_run=mysqli_query($conn,$sql);
}
?>
     <?php
    }
...
<div class="hcontent" id="i1">
  ...
  <div class="roomcontenta" id="ff1">
    <h1>I3 FirstFloor Room Details</h1>
    <?php
                $fill = "SELECT * from `roomdata` where hostel='i3' && floor='1' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='i3' && floor='1' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='i3' && floor='1' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
  ...
  <div class="roomcontenta" id="sf1">
    <h1>I3 SecondFloor Room Details</h1>
    <?php
                $fill = "SELECT * from `roomdata` where hostel='i3' && floor='2' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='i3' && floor='2' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='i3' && floor='2' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
  ...
  <div class="roomcontenta" id="tf1">
     <h1>I3 ThirdFloor Room Details</h1>
     <?php
                $fill = "SELECT * from `roomdata` where hostel='i3' && floor='3' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='i3' && floor='3' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='i3' && floor='3' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
...
include 'db_con.php';
 if (isset($_POST['uprom'])) {
  $id=$_POST['uid']; 
  $sql="UPDATE sdata SET uroom='$_POST[uroom]' WHERE uid='$id' ";
...
<div class="hcontent" id="k4">
  ...
  <div class="roomcontentb" id="ff2">
    ...
    <?php
                $fill = "SELECT * from `roomdata` where hostel='K4' && floor='1' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='K4' && floor='1' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='K4' && floor='1' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
  ...
  <div class="roomcontentb" id="sf2">
    ...
    <?php
                $fill = "SELECT * from `roomdata` where hostel='K4' && floor='2' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='K4' && floor='2' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='K4' && floor='2' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
  ...
  <div class="roomcontentb" id="tf2">
     ...
     <?php
                $fill = "SELECT * from `roomdata` where hostel='K4' && floor='3' && description='allocated'";
               $fill_run=mysqli_query($conn,$fill);
               $offill = "SELECT * from `roomdata` where hostel='K4' && floor='3' && description='pallocated'";
               $offill_run=mysqli_query($conn,$offill);
               $unfill = "SELECT * from `roomdata` where hostel='K4' && floor='3' && description='unallocated'";
               $unfill_run=mysqli_query($conn,$unfill);
                ?>
    <table style="margin-top: 15px; margin-left: 40px; height: 400px;">
      <tr>
...
if (isset($_POST['rsearch'])) {
  ...
  $sql="SELECT * FROM sdata WHERE uroom='$uroom'";
   ...
   <table style="margin-top: 15px; margin-left: 40px; height: 350px;">
    <tr class="tr2"><td></td><td style="margin-left: 10px;">NAME :</td><td><input type="text" name="uname" style="padding-right: 60px; margin-left: 3px;" value="<?php echo $row['uname'] ?>" strong></td></tr>
...
<div id="wd" class="tabcontent" style="overflow-y: scroll;">
  <form action="" method="post">
