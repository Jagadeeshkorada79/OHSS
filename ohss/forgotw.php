...
<body>
  <form action="forgotw.php" method="POST">
    <div class="login-box">
...
if (isset($_POST['update'])) {
  ...
  elseif (empty($cpass)) {
    ...
    $sqlw="SELECT * FROM logw WHERE username='$uname'";
    ...
    if (mysqli_num_rows($resultw) === 1) {
      ...
      if ($roww['username'] === $uname)  {
          if ($pass===$cpass) {
         $sqlw="UPDATE logw SET password='$pass' WHERE username='$uname' ";
