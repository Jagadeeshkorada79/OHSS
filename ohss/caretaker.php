...
$usermail=$_SESSION['username'];
  include 'db_con.php';
  $sqlc="SELECT * FROM ctdata WHERE uemail='$usermail'";
...
<body>
<center class="title">CARE TAKER</center>
<div class="container ct">
<div class="navbar">
  <a class="active" href="caretaker.php"><i class="fa fa-fw fa-home"></i> Home</a> 
  <a href="about.php"><i class="fa fa-fw fa-question"></i>About</a>
  <a href="contact.php"><i class ="fa fa-fw fa-envelope"></i>Contact</a>
   <a class="link dim dark-gray f3 dib mr3 mr4-l" href="caretaker.php" style="margin-left: 700px">WELCOME <?php echo $rowc['uname']; ?> </a>
...
<div id="id1" class="modal">
   ...
   <form action="" method="post">
    ...
    if(isset($_POST['notify'])){
      ...
      $note="INSERT INTO `notification`(`id`, `notification`, `udate`, `uby`) VALUES (NULL,'$notifi',CURRENT_TIMESTAMP,'caretaker')";
